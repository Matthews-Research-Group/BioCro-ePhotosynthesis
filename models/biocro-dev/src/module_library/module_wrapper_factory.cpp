...
#include "multilayer_c3ephotosynthesis_canopy.h"
...
module_wrapper_factory::module_wrapper_creator_map module_wrapper_factory::module_wrapper_creators =
{
     ...
     {"yggdrasil_c3ephotosynthesis_leaf",                &create_wrapper<yggdrasil_c3ephotosynthesis_leaf>},
     {"ten_layer_c3ephotosynthesis_canopy",             &create_wrapper<ten_layer_c3ephotosynthesis_canopy>}
};
